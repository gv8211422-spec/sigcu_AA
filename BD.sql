...
-- =================================================================
DELIMITER //
CREATE TRIGGER after_inscripcion_crear_calificacion
...
-- =================================================================
-- se modificaron estas tablas
-- =================================================================
ALTER TABLE grupos ADD COLUMN id_docente INT NOT NULL AFTER id_materia;
ALTER TABLE grupos ADD CONSTRAINT fk_grupo_docente FOREIGN KEY (id_docente) REFERENCES usuarios(id_usuario);